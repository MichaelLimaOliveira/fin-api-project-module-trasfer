...
import { CreateUserTransferenceController } from '../modules/statements/useCases/createUserTransference/CreateUserTransferenceController';

const statementRouter = Router();
const getBalanceController = new GetBalanceController();
const createStatementController = new CreateStatementController();
const getStatementOperationController = new GetStatementOperationController();
const createUserTransferenceController = new CreateUserTransferenceController();
...
statementRouter.post("/transfer/:userReceiverId", createUserTransferenceController.handle);
